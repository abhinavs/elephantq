...
| docs/cli/commands.md:35                      | `soniq start`                   | soniq/cli/start.py (`add_start_cmd`)                                                         | implemented | manual-only    |
...
| docs/production/checklist.md                    | `SONIQ_LOG_FORMAT`                 | soniq/settings.py:224 (`log_format`)                      | implemented | manual-only    |
...
| Source (file:line)                 | Symbol                            | Code reference                             | Status      | Smoke category |
| ---------------------------------- | --------------------------------- | ------------------------------------------ | ----------- | -------------- |
| deployment/soniq-worker.service    | `soniq start`                     | soniq/cli/start.py                         | implemented | manual-only    |
...
| deployment/supervisor.conf         | `soniq start` / `soniq scheduler` | soniq/cli/start.py, soniq/cli/scheduler.py | implemented | manual-only    |
| deployment/kubernetes.yaml         | `soniq start`                     | soniq/cli/start.py                         | implemented | manual-only    |
| deployment/docker-compose.yml      | `soniq start` / `soniq scheduler` | soniq/cli/start.py, soniq/cli/scheduler.py | implemented | manual-only    |
...
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ----------- |
| docs/contracts/queue_stats.md              | soniq/types.py (`QueueStats`); 3 backends' `get_queue_stats`                                                     | tests/contract/test_queue_stats_keys.py                                                  | implemented |
| docs/contracts/dead_letter.md              | 3 backends' `mark_job_dead_letter`; soniq/features/dead_letter.py (`move_job_to_dead_letter` deleted)            | tests/integration/dlq/test_dlq_contract.py (Group A x 3 backends, Group B postgres-only) | implemented |
| docs/design/dlq_option_a.md                | soniq/backends/postgres/migrations/0002_dead_letter_option_a.sql                                                 | tests/migrations/test_0002_dead_letter_option_a.py                                       | implemented |
