...
from .webhooks import (
    start_webhook_system as _start_webhook_system,
    stop_webhook_system as _stop_webhook_system,
    register_webhook as _register_webhook,
    unregister_webhook as _unregister_webhook,
    get_webhook_endpoints as _get_webhook_endpoints,
    get_delivery_stats as _get_delivery_stats
)
from .metrics import (
    get_system_metrics as _get_system_metrics,
    generate_performance_report as _generate_performance_report,
    check_performance_alerts as _check_performance_alerts,
    start_metrics_collection as _start_metrics_collection
)
from .logging import (
...
from .dead_letter import (
    setup_dead_letter_queue as _setup_dead_letter_queue,
    move_job_to_dead_letter as _move_job_to_dead_letter,
    resurrect_job as _resurrect_job,
    bulk_resurrect_jobs as _bulk_resurrect_jobs,
...
class WebhookManager:
    ...
    async def register_endpoint(self, url: str, events: List[str] = None, secret: str = None, **kwargs):
    ...
    async def get_status(self):
        ...
        return {
            "webhooks": {
                ...
                "delivery_stats": await self.webhooks.get_delivery_stats(1)  # Last hour
            },
