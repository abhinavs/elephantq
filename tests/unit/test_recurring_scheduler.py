...
class TestPriorityEnum:
    def test_priority_values(self):
        from soniq.features.recurring import Priority
...
class TestFluentRecurringScheduler:
    def test_priority_with_enum(self):
        from soniq.features.recurring import FluentRecurringScheduler, Priority
    ...
    def test_priority_with_int(self):
        from soniq.features.recurring import FluentRecurringScheduler
...
class TestTimeIntervalBuilder:
    def test_seconds(self):
        from soniq.features.recurring import TimeIntervalBuilder
...
class TestEveryFactory:
    def test_every_returns_time_interval_builder(self):
        from soniq.features.recurring import TimeIntervalBuilder, every
    ...
    def test_every_chained_with_minutes(self):
        from soniq.features.recurring import FluentRecurringScheduler, every
    ...
    def test_every_chained_with_hours(self):
        from soniq.features.recurring import every
...
class TestDailyWeeklyMonthly:
    def test_daily_returns_daily_scheduler(self):
        from soniq.features.recurring import daily

        scheduler = daily()
        assert scheduler.schedule_type == "cron"

    def test_weekly_returns_weekly_scheduler(self):
        from soniq.features.recurring import weekly

        scheduler = weekly()
        assert scheduler.schedule_type == "cron"

    def test_monthly_returns_monthly_scheduler(self):
        from soniq.features.recurring import monthly

        scheduler = monthly()
        assert scheduler.schedule_type == "cron"

    def test_hourly_returns_scheduler(self):
        from soniq.features.recurring import hourly
