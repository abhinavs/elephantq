...
class TestHealthCheckFunctions:
    ...
    @patch("elephantq.db.context.get_context_pool")
...
class TestHealthAPIFunctions:
    ...
    @patch("elephantq.health.check_database_health")
    @patch("elephantq.health.check_job_processing_health")
    @patch("elephantq.health.check_system_resources")
    ...
    @patch("elephantq.health.get_health_status")
    ...
    async def test_start_stop_health_monitoring_api(self):
        ...
        with (
            patch("elephantq.health.check_database_health") as mock_db,
            patch("elephantq.health.check_job_processing_health") as mock_proc,
            patch("elephantq.health.check_system_resources") as mock_res,
        ):
...
class TestCLIFunctions:
    ...
    @patch("elephantq.health.is_ready")
